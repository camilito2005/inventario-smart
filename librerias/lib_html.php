...
function Menu($inicio="#", $ruta_titulo="#", $titulo = "Inventario SmartInfo", $ruta_perfil="./vistas/usuarios.php?accion=perfil",$cerrar="./vistas/usuarios.php?accion=cerrar",$login="./vistas/login.php?accion=login-html&mensaje=",$aggequipos="./vistas/equipos.php?accion=verequipos&mensaje=",$ruta_categorias="./vistas/categorias.php?accion=vercategorias",$reportes="./vistas/estadisticas.php?accion=masmarcas",$verusuario="./vistas/usuarios.php?accion=ver&mensaje="){
    echo <<<HTML
...
echo<<<HTML
    <header class="bg-light text-center py-5">
        <div class="container">
            ...
            <a href="./vistas/equipos.php?accion=verequipos&mensaje=" class="btn btn-primary btn-lg">Explorar Inventario</a>
        </div>
    </header>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <a href="./vistas/equipos.php?accion=verequipos&mensaje=" class="btn btn-primary">Gestionar</a>
                    </div>
                </div>
            </div>
            <!-- Categorías -->
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <a href="./vistas/usuarios.php?accion=ver&mensaje=" class="btn btn-primary">Administrar</a>
                    </div>
                </div>
            </div>
            <!-- Alertas -->
...
Menu($inicio="../index.php",$ruta_titulo="../index.php", $titulo = "Inventario SmartInfo", $ruta_perfil="./usuarios.php?accion=perfil",$cerrar="./usuarios.php?accion=cerrar",$login="./login.php?accion=login-html&mensaje=",$aggequipos="./equipos.php?accion=aggequipos&mensaje=",$ruta_categorias="./categorias.php?accion=vercategorias",$reportes="./estadisticas.php?accion=masmarcas",$verusuario="./usuarios.php?accion=ver&mensaje=");
    echo <<<HTML
